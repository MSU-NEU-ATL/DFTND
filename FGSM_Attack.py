...
from Lpnorm_attacks import FGSM
...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_dir', type=str, default='result/FGSM', help="dir of the result")
    ...
    path = os.path.join(args.result_dir, 'FGSM_log.csv')
    ...
    FGSM = FGSM.FGSM(model, eps=64 / 255)
    if args.attack_goal == 'T':
        FGSM.set_attack_mode("targeted")
    ...
    for images, labels in img_loader:
        ...
        print('OG:', pred_class)
        print('OG %:', pred_prob)
        if pred_class is not idx2label[labels]:
        ...
        pred1_class = idx2label[pred1_label]
        ...
        if args.attack_goal == 'N':
            ...
            if pred1_label == args.attack_target:
                ...
                status = 'Uns'
        im.save('/home/liyize/Codes/AdvTool/result/FGSM/{}_{}_{}_{}_{}_{}_{}.jpg'.format(args.task,
                                                                                         args.attack_type,
                                                                                         args.attack_goal,
                                                                                         args.model_type,
